...
function XrOctahedron() {
    ...
    useFrame((state, delta) => {
        //console.log(cubeRef)    
        OctahedronRef.current.rotation.y += delta;
...
return (<>
    ...
    <ambientLight />
    {/*dentro del mesh se dibuja la figura, que en este caso es un octaedro (octahedron)*/}
    <mesh ref={OctahedronRef} position={[0, 0, -5]}>
